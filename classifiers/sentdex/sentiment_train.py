...
print(
    f'{"NaiveBayes_classifier accuracy:":<40}{(nltk.classify.accuracy(NaiveBayes_classifier, testing_set)*100):<.2f}%'
)
...
print(
    f'{"MNB_classifier accuracy:":<40}{(nltk.classify.accuracy(MNB_classifier, testing_set)*100):<.2f}%'
)
...
print(
    f'{"BernoulliNB_classifier accuracy:":<40}{(nltk.classify.accuracy(BernoulliNB_classifier, testing_set)*100):<.2f}%'
)

save_classifier = open(
    "pickled_algos/classifiers/BernoulliNB_classifier5k.pickle", "wb"
)
...
print(
    f'{"LogisticRegression_classifier accuracy:":<40}{(nltk.classify.accuracy(LogisticRegression_classifier, testing_set)*100):<.2f}%'
)

save_classifier = open(
    "pickled_algos/classifiers/LogisticRegression_classifier5k.pickle", "wb"
)
...
print(
    f'{"LinearSVC_classifier accuracy:":<40}{(nltk.classify.accuracy(LinearSVC_classifier, testing_set)*100):<.2f}%'
)
...
print(
    f'{"SGDC_classifier accuracy:":<40}{(nltk.classify.accuracy(SGDC_classifier, testing_set)*100):<.2f}%'
)
